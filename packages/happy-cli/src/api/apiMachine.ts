...
export class ApiMachineClient {
    ...
    setRPCHandlers({
        ...
        this.rpcHandlerManager.registerHandler('spawn-happy-session', async (params: any) => {
            const { directory, sessionId, machineId, approvedNewDirectoryCreation, agent, token, secret, environmentVariables } = params || {};
            ...
            const result = await spawnSession({ directory, sessionId, machineId, approvedNewDirectoryCreation, agent, token, secret, environmentVariables });
